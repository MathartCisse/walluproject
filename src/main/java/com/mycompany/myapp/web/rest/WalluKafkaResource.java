...
@RestController
@RequestMapping("/api/wallu-kafka")
public class WalluKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WalluKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WalluKafkaResource(KafkaProperties kafkaProperties) {
